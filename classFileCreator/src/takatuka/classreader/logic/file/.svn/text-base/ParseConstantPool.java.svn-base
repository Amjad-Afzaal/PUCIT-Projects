    ...
    public void parseCPInfo(MultiplePoolsFacade cpool, int cpsize) throws
        ...
        */
        ...
        while ((cpool.getCurrentSize()-alreadyCapacity) < cpsize) {
            ...
            switch (tag) {
            case CPTagValues.CONSTANT_Class: //7;
                infoBase = createClassInfo();
                break;
            case CPTagValues.CONSTANT_Fieldref: // 9;
                infoBase = createReferenceInfo(true);
                break;
            case CPTagValues.CONSTANT_Methodref: // 10;
                infoBase = createReferenceInfo(false);
                break;
            case CPTagValues.CONSTANT_InterfaceMethodref: //11;
                infoBase = createInterfaceMethodReferenceInfo();
                break;
            case CPTagValues.CONSTANT_String: // 8;
                infoBase = createStringInfo();
                break;
            case CPTagValues.CONSTANT_Integer: // 3;
                infoBase = createIntegerInfo();
                break;
            case CPTagValues.CONSTANT_Float: // 4;
                infoBase = createFloatInfo();
                break;
            case CPTagValues.CONSTANT_Long: // 5;
                infoBase = createLongInfo();
                break;
            case CPTagValues.CONSTANT_Double: // 6;
                infoBase = createDoubleInfo();
                break;
            case CPTagValues.CONSTANT_NameAndType: // 12;
                infoBase = createNameAndTypeInfo();
                break;
            case CPTagValues.CONSTANT_Utf8: // 1;
                infoBase = createUTF8Info();
                break;
                //case CPTagValues.CONSTANT_Empty:
