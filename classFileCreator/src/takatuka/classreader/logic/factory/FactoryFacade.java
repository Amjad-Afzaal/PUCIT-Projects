...
// Attributes
    public final Instruction createInstruction(int opcode, CodeAtt parentCodeAtt) throws
            Exception {
        return createInstruction(opcode, null, parentCodeAtt);
    }    
    ...
    public final Instruction createInstruction(int opcode, Un operands,
            ...
            Exception {
        if (parentCodeAtt == null) {
            throw new Exception("Programmers Error: Code Attribute should never be null");
        }
    ...
    public final CodeAtt createCodeAttribute(Un u2_attrNameIndex) throws
            Exception {
