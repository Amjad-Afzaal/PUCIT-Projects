...
public class StringUtil {
    ...
    public static String getString(Object[] objs, String seperator) {
        if (objs == null) {
            return "";
        }
        String ret = "";
    ...
    public static String getString(Vector objs, String seperator) {
        if (objs == null) {
            return "";
        }
        String ret = "";
        for (int loop = 0; loop < objs.size(); loop++) {
            ret += "("+loop+")"+ objs.elementAt(loop);
            if (loop + 1 < objs.size()) {
                ret = ret + seperator;
            }
        }
