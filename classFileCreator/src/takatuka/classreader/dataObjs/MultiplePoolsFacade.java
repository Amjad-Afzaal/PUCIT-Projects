...
public class MultiplePoolsFacade {
    ...
    /*public Object[] getPoolArray(int poolId) {
        Contro= pools.get(poolId);
     ...
     * @throws java.lang.Exception
     */
    public int add(Object obj, int poolId) throws ArrayIndexOutOfBoundsException,
            Exception {
