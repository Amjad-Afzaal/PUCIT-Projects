...
public class FieldInfo implements BaseObject {
    ...
    private AttributeInfoController attributesController = new AttributeInfoController(0);
    ...
    public static String createKey(Un descriptorIndex, Un index, MultiplePoolsFacade pOne) {
        Oracle oracle = Oracle.getInstanceOf();
        String name = oracle.getUTF8(index.intValueUnsigned(), pOne);
        String desc = oracle.getUTF8(descriptorIndex.intValueUnsigned(), pOne);
    ...
    public static String createKey(String methodDescriptionIndex, String nameIndex) {
        return nameIndex + "->" + methodDescriptionIndex;
    }
    ...
    public String getKey() {
        Oracle oracle = Oracle.getInstanceOf();
        MultiplePoolsFacade cp = getClassFile().getConstantPool();
        String name = oracle.methodOrFieldName(this, cp);
        String desc = oracle.methodOrFieldDescription(this, cp);
        return createKey(desc, name);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (fInfo.access_flags.equals(access_flags) && fInfo.name_index.equals(name_index)
                && fInfo.descriptor_index.equals(descriptor_index)
