...
public class ClassFile implements BaseObject, Comparable<ClassFile> {
    ...
    private InterfaceController interfaces = new InterfaceController(0);
    private FieldInfoController fieldController = new FieldInfoController(0);
    private MethodInfoController methodsCont = new MethodInfoController(0);
    private AttributeInfoController attributesCont = new AttributeInfoController(0);
    private String name;
    ...
    public String getFullyQualifiedClassName() {
        ...
        try {
            ...
            ClassInfo cinfo = (ClassInfo) base.get(this_class.intValueUnsigned(), CPTagValues.CONSTANT_Class);
...
//    }
    ...
    public void setFieldCount(Un u2) throws Exception {
        ...
        if (u2 != null) {
            this.fieldController = factory.createFieldInfoController(u2.intValueUnsigned());
        } else {
    ...
    public void setAttributesCount(Un attributes_count) throws Exception {
        ...
        if (attributes_count != null) {
            attributesCont = factory.createAttributeInfoController(
                    attributes_count.intValueUnsigned());
        } else {
