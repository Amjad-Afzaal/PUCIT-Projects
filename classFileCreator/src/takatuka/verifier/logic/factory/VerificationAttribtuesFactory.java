...
import takatuka.optimizer.bytecode.branchSetter.logic.factory.AttributesFactoryBH;
 ...
 * @version 1.0
 */
public class VerificationAttribtuesFactory extends AttributesFactoryBH {
    private static final AttributesFactory attFactoryLocal = new
            VerificationAttribtuesFactory();
    protected VerificationAttribtuesFactory() {
        super();
    }
    ...
    protected Instruction createInstruction(int opcode, Un operands, CodeAtt codeAtt) throws
            Exception {
        return new VerificationInstruction(opcode, operands, codeAtt);
    }
