...
public class IfAndCmpInstrs {
    ...
    protected void ifCmdInstruction(VerificationInstruction inst,
        ...
        nextPossibleInstructionsIds.addElement(this.getTargetInstrIds(inst).elementAt(0));
    }
    ...
    protected void cmpInstruction(OperandStack stack, int type,
        ...
        if (!Type.isCompatableTypes(val1, val2)) {
            Type.isCompatableTypes(val1, val2);
