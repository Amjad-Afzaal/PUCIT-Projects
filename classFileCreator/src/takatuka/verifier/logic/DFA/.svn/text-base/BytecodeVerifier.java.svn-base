...
public class BytecodeVerifier {
     ...
     * @throws Exception
     */
    public Vector execute(MultiplePoolsFacade pOne, VerificationInstruction inst,
        ...
        try {
            ...
            if (opcode == JavaInstructionsOpcodes.NOP) {
            ...
            } else if (opcode >= JavaInstructionsOpcodes.ILOAD
                ...
                exceptHandler.athrowInstruction(pOne, inst);
                ...
                miscInstr.instanceofInstruction(pOne, inst);
            ...
            String methodName = oracle.getMethodOrFieldString(currentMethod);
            System.err.println("at method=" + methodName + ", instruction=" + inst.getOffSet() + ":" + inst.getMnemonic() + "\n " + d);
            d.printStackTrace();
            System.exit(1);
        }
