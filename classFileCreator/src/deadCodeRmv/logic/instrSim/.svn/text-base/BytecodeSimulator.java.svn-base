 ...
 * @author Faisal Aslam
 */
public class BytecodeSimulator extends BytecodeVerifier {

    public BytecodeSimulator(Frame frame, MethodInfo currentMethod, Vector callingParameters) {
        super(frame, currentMethod, callingParameters);
    }
