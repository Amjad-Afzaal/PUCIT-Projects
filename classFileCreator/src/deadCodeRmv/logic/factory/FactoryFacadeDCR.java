 ...
 * @author Faisal Aslam
 */
public class FactoryFacadeDCR extends VerificationFactoryFacade {

    private static final FactoryFacadeDCR myObj = new FactoryFacadeDCR();
    ...
    protected ClassFileFactory getClassFileFactory() {
        return ClassFileFactoryDCR.getInstanceOf();
    }
    
    @Override
    protected AttributesFactory getAttFactory() {
        return AttributesFactoryDCR.getInstanceOf();
    }
}
