 ...
 * @author Faisal Aslam
 */
public class AttributesFactoryDCR extends VerificationAttribtuesFactory {
    private static final AttributesFactory attFactoryLocal = new
            AttributesFactoryDCR();
    
    protected AttributesFactoryDCR() {
        super();
    }
    ...
    protected Instruction createInstruction(int opcode, Un operands, CodeAtt codeAtt) throws
            Exception {
        return new InstructionDCR(opcode, operands, codeAtt);
    }
}
