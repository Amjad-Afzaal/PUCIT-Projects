 ...
 * @author Faisal Aslam
 */
public class InstructionDCR extends VerificationInstruction implements ShouldKeepInterface {

    /**
     * true if the class instruction be kept.
     * By default every instruction should be up for deletion.
     */
    private boolean shouldKeep = false;
    
    public InstructionDCR(int opcode, Un operands, CodeAtt codeAtt) {
